...
public class MapShoppingCartTest {
    ...
    @Test
    public void removeItemItemContainedOnceGivenShouldDeleteTheKey()
    ...
    @Test
    public void removeItemItemContainedMoreThanOnceGivenShouldDecreaseSizeWithoutDeletingTheKey()
            throws ItemNotFoundException {
        // Arrange
        this.cart.addItem(DEFAULT_APPLE);
        this.cart.addItem(DEFAULT_APPLE);
        this.cart.addItem(DEFAULT_CHOCOLATE);
        int sizeBeforeRemove = this.cart.getCartSize();

        // Act
        this.cart.removeItem(DEFAULT_APPLE);
        int sizeAfterRemove = this.cart.getCartSize();

        // Assert
        assertTrue(this.cart.containsItem(DEFAULT_APPLE));
